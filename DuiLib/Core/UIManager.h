...
#define UISTATE_CAPTURED     0x00000040
	...
	public:
		...
		static void SetProxy(LPCTSTR pstrProxy);
		...
		const TImageInfo* AddWebImage(LPCTSTR bitmap, DWORD mask = 0, bool bUseHSL = false, HINSTANCE instance = NULL);
		const TImageInfo* AddBase64Image(LPCTSTR bitmap, DWORD mask = 0, bool bUseHSL = false, HINSTANCE instance = NULL);
