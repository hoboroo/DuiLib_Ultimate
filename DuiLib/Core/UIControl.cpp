...
namespace DuiLib {
	...
	void CControlUI::SetToolTipDelayTime(int nTime)
	{
		m_nTooltipDelayTime = nTime;
	}

	int CControlUI::GetToolTipDelayTime()
	{
		return m_nTooltipDelayTime;
	}
