...
#define UILIST_MAX_COLUMNS 32
	...
	public:
		...
		void SelectAllItems();
		bool SelectItems(int nStartIndex, int nEndIndex);
		...
		bool IsEnsureVisible() { return m_bEnsureVisible; }
		void SetEnsureVisible(bool bEnsureVisible) { m_bEnsureVisible = bEnsureVisible; }
	...
	protected:
		...
		bool m_bEnsureVisible;	//选中时保证列表项显示完整
